...
motion_plot = CommandWork(f'motion_plot', [motion_estimate_dfile], [motion_plot_file], ['1dcat', [motion_estimate_dfile, '[1..6]{0..$}']], stdout= motion_plot_file, stdout_to_log= False)
